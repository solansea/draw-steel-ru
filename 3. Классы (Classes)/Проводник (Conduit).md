...
keywords: Магия, Дальний бой бой, Манёвр
type: Манёвр
...
effects:
- Effect: Каждая цель может потратить Восстановление. Дополнительно, каждая цель может использовать свободную Реакцию, чтобы завершить один эффект, который завершается спасброском или в конце её хода, или встать, если повалена.
