...
Отдельное передвижение или другой эффект никогда не могут позволить существу переместиться на большее количество клеток, чем его скорость, если только в эффекте не указано иное. Например, скорость существа со скоростью 5 может быть уменьшена до 2 из-за состояния «замедленный» (см. [Состояния](#page-91-2) в [Главе 5: Классы](#page-83-2)). Если союзник затем нацеливает на него эффект, позволяющий ему переместиться на 3 клетки, существо может переместиться только на 2 клетки, потому что это его текущая скорость.

#### Нельзя Срезать Углы

Существо не может перемещаться по диагонали, если при этом ему придется проходить через угол стены или другого объекта, полностью заполняющего угол между клеткой существа и клеткой, в которую оно перемещается. Это правило применяется только к прохождению мимо объектов, а не к прохождению мимо других существ.

###### Срезание Углов

Тактик перемещается на 3 клетки, чтобы выйти из здания, не сокращая углы. Пёс Войны-эвисцирит не может обойти здание всего за 2 клетки, так как для этого ей пришлось бы срезать угол.

#### Сдвинуться

Сдвиг — это осторожная форма движения, которая позволяет существу безопасно пройти мимо опасных врагов. Некоторые способности, особенности и другие правила позволяют вам сдвигаться на определенное количество клеток, иногда до вашей скорости. Когда вы сдвигаетесь, существа не могут наносить вам атаки по возможности, вызванные этим движением (см. [Атаки по возможности](#page-289-4) далее в этой главе).

Вы не можете сдвигаться в труднопроходимую местность или местность, наносящую урон (см. ниже), а также находясь в ней. Если правило позволяет вам сдвигаться, вы можете вместо этого выбрать перемещение на количество клеток, на которое вы бы сдвинулись (например, чтобы выйти из труднопроходимой местности). Однако вы не можете комбинировать перемещение и сдвиг в рамках одного движения.
