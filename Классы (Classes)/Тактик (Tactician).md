...
Хотя вы не можете получать концентрацию вне боя, вы можете использовать свои героические способности и эффекты, требующие концентрацию, без её расхода. Каждый раз, когда вы используете способность или эффект вне боя, требующий концентрацию, вы не можете использовать ту же способность или эффект вне боя снова, пока не заработаете 1 или более Побед или не закончите отдых.
...
- Эффект: В любой момент во время движения цели один союзник может совершить по ней бесплатный удар.
...
target: Одно существо  
effects:
- Эффект: Цель отмечена вами до конца столкновения, пока вы не умираете или пока вы не используете эту способность снова. Вы можете добровольно снять метку (не требует действия), и если другой тактик накладывает метку на существо, ваша метка на нём заканчивается. Когда отмеченное вами существо Выносливость до 0, вы можете использовать бесплатную реакцию, чтобы отметить новую цель в пределах дистанции.
...
- Когда вы или союзник используете способность, чтобы нанести урон в результате броска по отмеченному существу, вы можете потратить 1 концентрацию и получить одно из следующих преимуществ как бесплатную реакцию 
...
target: Один союзник  
effects:
- Эффект: Цель может использовать знаковую способность как бесплатную реакцию.
...
effects:
- roll: Бросок Могущества + Сила  
  11 or lower: 5 + Сила урона; один союзник в пределах 10 клеток может использовать удар знаковой способностью по цели в качестве бесплатной реакции.  
  12-16: 9 + Сила урона; один союзник в пределах 10 клеток может удар знаковой способностью с преимуществом против цели в качестве бесплатной реакции.  
  17+: 12 + Сила урона; два союзника в пределах 10 клеток могут каждый использовать удар знаковой способностью с преимуществом против цели в качестве бесплатной реакции.
...
target: Три союзника
effects:
- Effect: Каждая цель может совершить бесплатный удар.
```
