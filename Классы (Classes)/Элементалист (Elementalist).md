...
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| 1-й   |  [[Элементалист (Elementalist)#Стихийная специализация\|Стихийная специализация]], [[Элементалист (Elementalist)#Эссенция\|Эссенция]], [[Элементалист (Elementalist)#### Стихийный бросок (Hurl Element)\|Стихийный бросок]], [[Элементалист (Elementalist)#### Постоянная магия (Persistent magic)\|Постоянная магия]], [[Элементалист (Elementalist)#Практическая магия (Practical Magic)\|Практическая магия]], [[Элементалист (Elementalist)#Особенности 1-го уровня\|Особенности 1-го уровня]], [[Элементалист (Elementalist)#Реакция специализации\|Реакция специализации]], [[Элементалист (Elementalist)#Зачарование\|Зачарование]], [[Элементалист (Elementalist)#Оберег элементалиста\|Оберег элементалиста]], [[Элементалист (Elementalist)#Способности элементалиста\|Способности элементалиста]] | Две знаковые, 3, 5               |
