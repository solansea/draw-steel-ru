...
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Слабая интенсивность                                  | Присутствие - 2                                                                                                                                                       |
| Средняя интенсивность                                 | Присутствие - 1                                                                                                                                                       |
| Сильная интенсивность                                 | Присутствие                                                                                                                                                           |
...
- **Экзорцист:** Вы специализируетесь на охоте за скрытыми врагами вашего ордена, зная, что открытый разум — это неохраняемая крепость. Вы обладаете навыком Чтение человека.    
...
- Option 3: Когда существо под вашим судом в пределах 10 клеток использует способность с Воздействием, направленным на только одно существо, Воздействие уменьшается на 1 для этого существа.
...
#### Характерная Способность

Выберите одну характерную способность из следующих вариантов. Характерные способности можно использовать по желанию.  
