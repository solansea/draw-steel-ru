...
| ----- | ---------------------------------------------------------------------------------------------------------- | ------------------------------ | -------------------- |
| 1st   | [[Цензор (Censor)#Орден цензора\|Орден Цензора]], [[Цензор (Censor)#Божество и домены\|Божество и домены]], [[Цензор (Censor)#Гнев\|Гнев]], [[Цензор (Censor)#Суд\|Суд]], [[Цензор (Censor)#Набор\|Комплект]], [[Цензор (Censor)#Моя жизнь за твою (My Life for Yours)\|Моя жизнь за твою (My Life for Yours)]], [[Цензор (Censor)#Особенность домена 1-го уровня\|Особенность домена 1-го уровня]], [[Цензор (Censor)#Способности Цензора\|Способности Цензора]] | Знаковая, 3, 5                | -                    |
