...
**Стартовые характеристики:** Вы начинаете с Ловкости 2 и Интуиции 2, и вы можете выбрать один из следующих наборов значений ваших других характеристик.  
2, -1, -1  
или 1, 1, -1  
или 1, 0, 0
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------------- |
| 1-й   | [[Нуль (Null)#Традиция Нуля\|Традиция Нуля]], [[Нуль (Null)#Дисциплина\|Дисциплина]], [[Нуль (Null)#Поле Нуля\|Поле Нуля]], [[Нуль (Null)#Инерционный Щит\|Инерционный Щит]], [[Нуль (Null)#Мастерство Дисциплины\|Мастерство Дисциплины]], [[Нуль (Null)#Скорость Нуля\|Скорость Нуля]], [[Нуль (Null)#Псионическое Усиление\|Псионическое Усиление]], [[Нуль (Null)#Псионическое Боевое Искусство\|Псионическое Боевое Искусство]], [[Нуль (Null)#Способности Нуля\|Способности Нуля]] | Две знаковые, 3, 5            | -                   |
...
effects:
- Effect: Вы можете сдвинуться (shift) на половину вашей скорости до или после выполнения этого удара. Кроме того, когда эффект позволяет совершить свободный удар или использовать знаковую способность, вы можете использовать эту способность вместо этого, платя её стоимость дисциплиной как обычно.
- roll: Бросок Могущества + Ловкость
  t1: 7 + Ловкость урона
...
- Effect: До начала вашего следующего хода, когда цель движется или подвергается принудительному перемещению, вы можете использовать свободную реакцию, чтобы сдвинуться (shift) до значения вашей скорости. Вы должны закончить этот сдвиг рядом с целью.
```
...
- roll: Бросок Могущества + Ловкость
  ...
  t2: 9 урона
  t3: 13 урона
- Effect: Вы можете совершить действие Отступление как свободный манёвр до или после использования этой способности.
```
