...
Хотя вы не можете получать дисциплину вне боя, вы можете использовать свои героические способности и эффекты, требующие дисциплину, без её траты. Всякий раз, когда вы используете способность или эффект вне боя, требующий дисциплину, вы не можете использовать ту же способность или эффект вне боя снова, пока не заработаете 1 или более Побед или не завершите отдых.
