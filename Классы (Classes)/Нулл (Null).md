...
Разум неотделим от тела. Совершенство одного требует совершенства другого. Вы стремитесь к безупречной дисциплине, идеальному порядку, овладению разумом и телом, становясь безоружным псионическим воином, который подавляет и поглощает магию и психику. Вам не нужны оружие или инструменты. Вы самодостаточны.

**Как Нулл, вы противостоите сверхъестественным силам вселенной с помощью самообладания и уверенности. Стремясь к идеальному порядку, вы становитесь врагом высшего проявления хаоса — сверхъестественного. Те, кто нарушает законы природы с помощью магии или психики, должны бояться вас.**
...
| --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Слабое Воздействие                                  | Интуиция - 2                                                                                                                                                            |
| Среднее Воздействие                                 | Интуиция - 1                                                                                                                                                            |
| Сильное Воздействие                                 | Интуиция                                                                                                                                                                |
...
Благодаря интенсивной физической и психической подготовке вы научились раскрывать весь потенциал своего тела. По мере того как вы развиваете свои способности, вы выбираете традицию Нулла из следующих вариантов, каждая из которых даёт вам навык. (_Быстрая сборка:_ Хронокинез и навык "Монстры".)
...
Ваша традиция Нулла является вашим подклассом, и выбор традиции определяет многие особенности, которые вы получите с ростом уровня.
#### Дисциплина
...
Кроме того, первый раз в каждом раунде, когда враг в зоне действия вашей способности Поле Нулла использует основное действие, вы получаете 1 дисциплину. Первый раз в каждом раунде, когда Режиссёр использует способность, требующую Злорадство (Malice), вы получаете 1 дисциплину.
...
Если вы используете способность вне боя, которая позволяет тратить неограниченное количество дисциплины на её эффект, вы можете использовать её так, как если бы потратили количество дисциплины, равное вашему числу Побед. (Такие способности не входят в основные правила для Нулла, но могут появиться в будущих продуктах.)
#### Таблица развития Нулла

| Level | Features                                                                                                                                                                 | Abilities                     | Tradition Abilities |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------------- |
| 1-й   | Традиция Нулла, Дисциплина, Поле Нулла, Инерционное Поле, Мастерство Дисциплины, Скорость Нулла, Псионическое Усиление, Псионическое Боевое Искусство, Способности Нулла | Две характерные, 3, 5         | -                   |
...
effects:
- Effect: Каждое существо уменьшает своё Воздействие на 1.
- Один раз за ваш ход, как бесплатный манёвр, вы можете потратить 1 дисциплину и выбрать один дополнительный эффект для Поля Нулла до начала вашего следующего хода
...
- Синаптический Разрыв: когда вы или союзник используете способность против цели с эффектом Воздействия, эффект Воздействия увеличивается на 1.
...
По мере вашего продвижения в выбранной традиции Нулла вы получаете определённые преимущества в бою, включая бонусы, зависящие от количества дисциплины. Бонусы, зависящие от количества дисциплины, действуют до конца вашего хода, даже если бонус становится недоступным из-за траты дисциплины в ходе этого хода.
...
| 4                 | Первый раз за ход, когда вы захватываете существо или враг сдвигается на 1 или более клеток в области действия способности **Поле Нулла**, вы получаете 1 **Всплеск**.                                                                          |
| 6                 | Вы получаете **Преимущество** на манёвры **Захват** и **Отбрасывание**.                                                                                                                                                                         |
| 8 (4-й уровень)   | Первый раз за ход, когда вы захватываете существо или враг сдвигается на 1 или более клеток в области действия способности **Поле Нулла**, вы получаете 2 **Всплеска**.                                                                         |
| 10 (7-й уровень)  | Вы имеете **Двойное преимущество** на манёвры **Захват** и **Отбрасывание**.                                                                                                                                                                    |
| 12 (10-й уровень) | Каждый раз, когда вы сдвигаете цель силой, расстояние сдвига увеличивается на значение вашего **Интуиция**. Кроме того, каждый раз, когда вы используете **героическую способность**, вы получаете 10 временной **Выносливости**.               |
...
Выберите две характерные способности из следующих вариантов. Характерные способности можно использовать по желанию. (_Быстрая сборка:_ Быстрее, чем глаз, Псионический шаг - Faster Than the Eye, Inertial Step.)
...
effects:
- Effect: Вы можете сдвинуться (shift) на половину вашей скорости до или после выполнения этого удара. Кроме того, когда эффект позволяет совершить бесплатный удар или использовать характерную способность, вы можете использовать эту способность вместо этого, платя её стоимость дисциплиной как обычно.
- roll: Бросок Могущества + Ловкость
  t1: 7 + Ловкость урона
...
cost: 3 дисциплины
effects:
- Effect: Каждое существо получает психический урон, равный удвоенному значению вашей Интуиции. До начала вашего следующего хода размер вашей способности Поле Нулла увеличивается на 1. В конце вашего текущего хода каждое существо в области вашей способности Поле Нулла получает психический урон, равный значению вашей Интуиции.
```
```ds-ab
...
- Effect: Пока цель ослаблена таким образом, она получает урон, равный вашему Разуму, каждый раз, когда использует сверхъестественную способность, требующую Злорадства.
```
