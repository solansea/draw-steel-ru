...
cost: 3 ясности
effects:
- Effect: Броски способности против цели совершаются с помехой до начала вашего следующего хода. Каждый раз, когда цель получает урон под этим эффектом, она может использовать реакцию и нанести свободный удар по источнику урона.
```
